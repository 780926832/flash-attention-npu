...
# Image builds wget/pip from pytorch.org and gitcode.com. Do not inherit a runner
# HTTP_PROXY, or BuildKit will send those downloads through the GitHub-only proxy.
...
find_wheel() {
  local fname="$1" path
  # WHEEL_SEARCH_PATHS is intentionally a space-separated list of roots.
